...
function Complementary_Highlights(colo)
	...
	elseif colo == "gruvbox" then
		colors = { bg_float = "#2D3031", bg_float_brighter="#3D4041", title="#427B58", prompt = "#D65D03", preview = "#458588"}
	elseif colo == "rose-pine" then
		colors = { bg_float = "#292734", bg_float_brighter="#393744", title="#31748F", prompt = "#F6C177", preview = "#C4A7E7"}
	...
	vim.api.nvim_set_hl(0, "TelescopePreviewBorder",	{ bg = colors.bg_float_brighter, 	fg = colors.bg_float_brighter })
	vim.api.nvim_set_hl(0, "TelescopePromptBorder",		{ bg = colors.bg_float_brighter, 	fg = colors.bg_float_brighter })
	vim.api.nvim_set_hl(0, "TelescopeResultsBorder",	{ bg = colors.bg_float_brighter, 	fg = colors.bg_float_brighter })
	vim.api.nvim_set_hl(0, "TelescopeNormal",		{ bg = colors.bg_float_brighter })
